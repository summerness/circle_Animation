...
-(void)CreatUI
{
    ...
    clipBtn.frame = CGRectMake(0,self.view.frame.size.height-45,self.view.frame.size.width, 45);
    clipBtn.backgroundColor = [UIColor colorWithRed:27.0/255.0 green:164.0/255.0 blue:242.0/255.0 alpha:1.0];
    [self.view addSubview:clipBtn];
    UILabel *lable = [[UILabel alloc]init];
    lable.frame = clipBtn.bounds;
    lable.text = @"确   定";
    lable.font = [UIFont fontWithName:@"Georgia-Bold" size:20];
    lable.textColor = [UIColor whiteColor];
    lable.textAlignment = NSTextAlignmentCenter;
    [clipBtn addSubview:lable];
