...
- (id)initSheetWithTitle:(NSString *)title
              ...
              itemTitles:(NSArray *)itemTitles images:(NSArray *)images
{
    if (self = [super initWithFrame:[[UIScreen mainScreen] bounds]]) {

        self.sheetStyle = style;
        self.dataSource1 = itemTitles;
        self.dataSource2 = images;
        ...
        self.sheetView.dataSource1 = self.dataSource1;
        self.sheetView.dataSource2 = self.dataSource2;
...
{
    NSInteger indexsCount = (NSInteger)self.dataSource1.count;
    if (indexsCount) {
